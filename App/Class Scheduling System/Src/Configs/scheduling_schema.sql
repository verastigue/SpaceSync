...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 03, 2024 at 07:32 PM
...
CREATE TABLE `tbl_instructors` (
  `id` int(11) NOT NULL,
  `instructor_no` varchar(100) NOT NULL,
  `firstname` varchar(100) NOT NULL,
  `lastname` varchar(100) NOT NULL,
  `email` varchar(100) NOT NULL,
  `gender` enum('Male','Female') NOT NULL,
  `employee_status` enum('Part Time','Full Time') NOT NULL,
  `availability` set('Monday','Tuesday','Wednesday','Thursday','Friday','Saturday','Sunday') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `tbl_schedules` (
  ...
  `class_day` set('Monday','Tuesday','Wednesday','Thursday','Friday','Saturday','Sunday') NOT NULL,
...
--
ALTER TABLE `tbl_curriculums`
  ADD CONSTRAINT `tbl_curriculums_ibfk_1` FOREIGN KEY (`program_code`) REFERENCES `tbl_programs` (`program_code`),
  ADD CONSTRAINT `tbl_curriculums_ibfk_2` FOREIGN KEY (`course_code`) REFERENCES `tbl_courses` (`course_code`);

--
-- Constraints for table `tbl_enrollments`
--
ALTER TABLE `tbl_enrollments`
  ADD CONSTRAINT `tbl_enrollments_ibfk_1` FOREIGN KEY (`course_code`) REFERENCES `tbl_courses` (`course_code`),
  ADD CONSTRAINT `tbl_enrollments_ibfk_2` FOREIGN KEY (`student_no`) REFERENCES `tbl_students` (`student_no`);

--
-- Constraints for table `tbl_schedules`
--
ALTER TABLE `tbl_schedules`
  ADD CONSTRAINT `tbl_schedules_ibfk_1` FOREIGN KEY (`course_code`) REFERENCES `tbl_courses` (`course_code`),
  ADD CONSTRAINT `tbl_schedules_ibfk_2` FOREIGN KEY (`instructor_no`) REFERENCES `tbl_instructors` (`instructor_no`),
  ADD CONSTRAINT `tbl_schedules_ibfk_3` FOREIGN KEY (`room_no`) REFERENCES `tbl_rooms` (`room_no`);

--
-- Constraints for table `tbl_sections`
--
ALTER TABLE `tbl_sections`
  ADD CONSTRAINT `tbl_sections_ibfk_1` FOREIGN KEY (`program_code`) REFERENCES `tbl_programs` (`program_code`);

--
-- Constraints for table `tbl_sessions`
--
ALTER TABLE `tbl_sessions`
  ADD CONSTRAINT `tbl_sessions_ibfk_1` FOREIGN KEY (`instructor_no`) REFERENCES `tbl_instructors` (`instructor_no`);

--
-- Constraints for table `tbl_subjects`
--
ALTER TABLE `tbl_subjects`
  ADD CONSTRAINT `tbl_subjects_ibfk_1` FOREIGN KEY (`course_code`) REFERENCES `tbl_courses` (`course_code`),
  ADD CONSTRAINT `tbl_subjects_ibfk_2` FOREIGN KEY (`instructor_no`) REFERENCES `tbl_instructors` (`instructor_no`);
COMMIT;
